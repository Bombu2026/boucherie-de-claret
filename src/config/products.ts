...
export const products: Product[] = [
  // --- Boeuf Premium ---
  {
    ...
    imagePrompt: "Wagyu A5 beef slices on dark wooden cutting board, extreme marbling visible, warm studio lighting, smoke wisps, premium butcher shop atmosphere, ultra realistic food photography",
    badge: "Exception",
    featured: true,
  },
  {
    ...
    imagePrompt: "Premium beef entrecote on rustic wooden board, red meat with fine marbling, rosemary sprigs, coarse salt, dark moody lighting, artisan butcher style",
    badge: "Populaire",
    featured: true,
  },
  {
    ...
    imagePrompt: "Dry aged bone-in ribeye steak 60 days, dark crust exterior, deep red interior, on massive wooden butcher block, dim warm lighting, premium steakhouse quality",
    badge: "60 jours",
    featured: true,
  },
  {
    ...
    imagePrompt: "Dark premium beef cuts, almost black red meat, on slate board with butcher knife, moody dark background, subtle smoke, luxury food photography",
    badge: "Rare",
  },
  {
    id: "aubrac-tradition",
  ...
  },
  {
    ...
    imagePrompt: "Lean Charolaise beef steaks on dark wood, bright red lean meat, butter pat melting, classic French bistro style, warm candlelight atmosphere",
  },
  {
    id: "gasconne-terroir",
    ...
    imagePrompt: "Rustic Gascon beef cuts on old wooden table, mountain herbs, dried peppers, Pyrenees terroir atmosphere, warm earthy tones, artisanal setting",
  },
  ...
  },
  {
    ...
    imagePrompt: "French country pate terrine in ceramic dish, rustic texture, cornichons and crusty bread alongside, warm farmhouse kitchen, traditional French cuisine",
  },
  ...
  // --- Box & Colis ---
  {
    ...
    imagePrompt: "Premium BBQ meat assortment box, steaks sausages merguez skewers arranged in gift box, dark wood background, charcoal grill visible, outdoor summer atmosphere",
    badge: "Best-seller",
    featured: true,
  },
  {
    ...
    imagePrompt: "Discovery meat box with 5 different beef cuts neatly arranged, each labeled, elegant gift packaging, dark premium background, food photography",
    badge: "Découverte",
  },
  {
    id: "box-prestige",
    ...
    imagePrompt: "Luxury prestige meat gift box, wagyu and premium cuts in black gift case, gold tissue paper, ultra premium packaging, dark studio lighting, advertising quality",
    badge: "Prestige",
  },
];
...
export const partnerProducts: PartnerProduct[] = [
  // --- Vins ---
  {
    ...
    imagePrompt: "Bottle of Côtes de Provence red wine with glass, dark background, vineyard atmosphere, warm candlelight, premium wine photography",
    badge: "Accord viande",
  ...
  },
  {
    ...
    imagePrompt: "Saint-Emilion Grand Cru bottle, aged oak barrel background, burgundy wine glass, French wine cellar atmosphere, luxury",
    badge: "Premium",
  ...
  },
  {
    ...
    imagePrompt: "Provence rosé wine bottle and glass, pale pink color, Mediterranean terrace setting, summer light, French Riviera style",
  ...
  // --- Sauces & Marinades ---
  {
    ...
    imagePrompt: "Artisanal pepper sauce in small glass jar, green peppercorns visible, dark rustic background, steak in background blur, gourmet food photography",
    pairsWith: ["boeuf-premium"],
  ...
  },
  {
    ...
    imagePrompt: "BBQ marinade in glass bottle, smoked paprika color, rosemary and honey visible, grill in background, outdoor cooking atmosphere",
    badge: "BBQ",
  ...
  },
  {
    ...
    imagePrompt: "Dijon whole grain mustard in stoneware pot, mustard seeds scattered, rustic Burgundy kitchen, artisanal French condiment",
  ...
  // --- Épices & Condiments ---
  {
    ...
    imagePrompt: "Fleur de sel Guérande in wooden bowl, salt crystals close-up, Atlantic coast atmosphere, natural hand-harvested salt, minimalist premium",
  ...
  },
  {
    ...
    imagePrompt: "Kampot black pepper in dark wooden mortar, whole peppercorns scattered, exotic Asian spice, dark moody lighting, luxury ingredient",
    badge: "IGP",
    pairsWith: ["boeuf-premium"],
    tags: ["boeuf", "maturé", "wagyu", "prestige"],
  },
  {
    ...
    imagePrompt: "Spice blend for grilling in small bowls, paprika cumin coriander garlic, vibrant colors on dark slate, barbecue season, overhead food photography",
    pairsWith: ["saucisses-maison", "box-colis", "boeuf-premium"],
    tags: ["grillades", "barbecue", "saucisses"],
  },
  ...
  // --- Accompagnements ---
  {
    ...
    imagePrompt: "French cornichons in glass jar, small crunchy gherkins, vinegar brine visible, traditional French condiment, rustic kitchen setting",
  ...
  },
  {
    ...
    imagePrompt: "Rustic sourdough country bread, thick crust, flour dusted, on wooden board, French bakery atmosphere, warm golden tones",
    pairsWith: ["charcuterie"],
